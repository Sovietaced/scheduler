...
const (
	ExecutorService_Sync_FullMethodName = "/server.ExecutorService/Sync"
)
...
func (c *executorServiceClient) Sync(ctx context.Context, in *SyncRequest, opts ...grpc.CallOption) (*SyncResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SyncResponse)
	err := c.cc.Invoke(ctx, ExecutorService_Sync_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedExecutorServiceServer) Sync(context.Context, *SyncRequest) (*SyncResponse, error) {
...
func _ExecutorService_Sync_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SyncRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ExecutorServiceServer).Sync(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ExecutorService_Sync_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ExecutorServiceServer).Sync(ctx, req.(*SyncRequest))
	}
...
var ExecutorService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "server.ExecutorService",
	HandlerType: (*ExecutorServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Sync",
			Handler:    _ExecutorService_Sync_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "server/executor.proto",
}
