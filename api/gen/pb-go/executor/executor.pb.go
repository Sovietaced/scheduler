...
const file_executor_executor_proto_rawDesc = "" +
	"\n" +
	"\x17executor/executor.proto\x12\bexecutor\"\"\n" +
	...
	"\bSayHello\x12\x16.executor.HelloRequest\x1a\x14.executor.HelloReplyB\x95\x01\n" +
	"\fcom.executorB\rExecutorProtoP\x01Z6github.com/sovietaced/scheduler/api/gen/pb-go/executor\xa2\x02\x03EXX\xaa\x02\bExecutor\xca\x02\bExecutor\xe2\x02\x14Executor\\GPBMetadata\xea\x02\bExecutorb\x06proto3"
...
var file_executor_executor_proto_goTypes = []any{
	(*HelloRequest)(nil), // 0: executor.HelloRequest
	(*HelloReply)(nil),   // 1: executor.HelloReply
}
var file_executor_executor_proto_depIdxs = []int32{
	0, // 0: executor.ExecutorService.SayHello:input_type -> executor.HelloRequest
	1, // 1: executor.ExecutorService.SayHello:output_type -> executor.HelloReply
